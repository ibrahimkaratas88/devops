...
[Service]
Environment="KUBELET_EXTRA_ARGS=--register-with-taints=worker4=four:NoSchedule --container-runtime=remote --runtime-request-timeout=15m --container-runtime-endpoint=unix:///run/containerd/containerd.sock"
EOF
systemctl daemon-reload
